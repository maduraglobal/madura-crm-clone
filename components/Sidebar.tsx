                ...
                <nav className="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
                    ...
                    {isTasksOnlyUser ? (
                        ...
                        <>
                            ...
                            <ul>
                                <NavItem icon={<IconEmployees className="w-5 h-5" />} label="Employees" path="/employees" isCollapsed={isCollapsed} />
                            </ul>
                        </>
                        ...
                        <>
                            ...
                            {isPrivilegedUser && (
                                <>
                                    ...
                                    <ul>
                                        <CollapsibleNav icon={<ManageIcon className="w-5 h-5" />} label="Manage" activePaths={['/employees']} isCollapsed={isCollapsed}>
